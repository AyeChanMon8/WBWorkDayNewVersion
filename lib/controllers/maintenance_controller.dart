...
class MaintenanceController extends GetxController {
  ...
  var maintenanceProductCategorys =
      List<Maintenance_product_category_model>().obs;
  ...
  getMaintenanceList(String status) async {
    ...
    await maintenanceService
        .getMaintenanceRequestList(int.tryParse(employee_id), status)
        .then((data) {
  ...
  void createMaintenanceRequest() async {
    ...
    if (from_date_time.isEmpty || to_date_time.isEmpty) {
      Get.snackbar('Warning', "Please Choose Date!",
          snackPosition: SnackPosition.BOTTOM);
    }
    if (descriptionTextController.text == null ||
      ...
      await maintenanceService
          .createMaintenanceRequestModel(
              ...
              from_date_time,
              to_date_time,
              maintenanceProductIdLists,
              priority.toInt(),
              descriptionTextController.text,
              imageList,
              before_image_one_base64,
              before_image_two_base64,
              before_image_three_base64,
              after_image_one_base64,
              after_image_two_base64,
              after_image_three_base64,
              selectedVehicle,
              formattedTodayDate)
          .then((data) {
        if (data != null) {
  ...
  void clickReproposeButton(int id) async {
    ...
    var employee_id = box.read('emp_id');
    await maintenanceService
        .submitReproposeButton(employee_id, id, current_page.value)
        .then((data) {
      maintenanceList.value = data;
      Get.back();
      Get.back();
  ...
  void updateEndDate(int id) async {
    if (selectedEndDate != null) {
      var start_date = DateFormat('yyyy-MM-dd HH:mm')
          .parse(selectedEndDate.toString())
      ...
      var employee_id = box.read('emp_id');
      await maintenanceService
          .updateEndDate(employee_id, id, start_date, current_page.value)
          .then((data) {
        maintenanceList.value = data;
        Get.back();
        Get.back();
  ...
  void updateStartDate(int id) async {
    if (selectedStartDate != null) {
      var start_date = DateFormat('yyyy-MM-dd HH:mm')
          .parse(selectedStartDate.toString())
          .subtract(Duration(hours: 6, minutes: 30))
          .toString()
          .split('.')[0];
      Future.delayed(
      ...
      var employee_id = box.read('emp_id');
      await maintenanceService
          .updateStartDate(employee_id, id, start_date, current_page.value)
          .then((data) {
        maintenanceList.value = data;
        Get.back();
        Get.back();
  ...
  void approveMaintenance(int id) async {
    ...
    var employee_id = box.read('emp_id');
    await maintenanceService
        .approveMaintenance(employee_id, id, current_page.value)
        .then((data) {
      if (data != null) {
        Get.back();
  ...
  void rejectMaintenance(int id) async {
    ...
    var employee_id = box.read('emp_id');
    await maintenanceService
        .rejectMaintenance(employee_id, id, current_page.value)
        .then((data) {
      if (data != null) {
        Get.back();
  ...
  void secondApprove(int id) async {
    ...
    var employee_id = box.read('emp_id');
    await maintenanceService
        .secondApproveMaintenance(employee_id, id, current_page.value)
        .then((data) {
      if (data != null) {
        Get.back();
        AppUtils.showConfirmDialog('Information', "Successfully Approved!",
  ...
  void resubmitClick(int id) async {
    ...
    var employee_id = box.read('emp_id');
    await maintenanceService
        .reSubmitButton(employee_id, id, current_page.value)
        .then((data) {
      maintenanceList.value = data;
      Get.back();
      Get.back();
  ...
  void clickQCButton(int id) async {
    ...
    var employee_id = box.read('emp_id');
    await maintenanceService
        .submitQCButton(employee_id, id, current_page.value)
        .then((data) {
      maintenanceList.value = data;
      Get.back();
      Get.back();
  ...
  void clickStartButton(int id) async {
    ...
    var employee_id = box.read('emp_id');
    await maintenanceService
        .submitStartButton(employee_id, id, current_page.value)
        .then((data) {
      maintenanceList.value = data;
      Get.back();
      Get.back();
  ...
  getMaintenanceProductCategorys() async {
    ...
    //fetch emp_id from GetX Storage
    await maintenanceService
        .getProductCategory(int.tryParse(company_id))
        .then((data) {
  ...
  getMaintenanceProductList(int id) async {
    ...
    var company_id = box.read('emp_company');
    await maintenanceService
        .getProductList(id, company_id.toString())
        .then((data) {
  ...
  void createProductLine(
      Maintenance_product_id maintenance_product_id, var id) async {
    await maintenanceService
        .createProductLine(id, maintenance_product_id, box.read('emp_id'))
        .then((data) {
      maintenanceList.value = data;
    });
  }
  ...
  void updateImageFile(var id, var index, String imageFile) async {
    await maintenanceService
        .updateImage(id, index, imageFile, box.read('emp_id'))
        .then((data) {
      maintenanceList.value = data;
    });
  }
  ...
  void onChangeProductCategoryDropdown(
      Maintenance_product_category_model
          maintenance_product_category_model) async {
    this.selectedProductCategory.value = maintenance_product_category_model;
    update();
    getMaintenanceProductList(this.selectedProductCategory.value.id);
  }

  void onChangeProductDropdown(Product_id product_id) async {
    this.selectedProduct.value = product_id;
    update();
  }

  void onChangeProductTypeDropdown(String type) async {
    this.selectedProductType.value = type;
    update();
  }

  void updateMaintenanceProductId(
      int id, Maintenance_product_ids maintenance_product_id) {
    this.maintenanceProductIds.add(maintenance_product_id);
    this.maintenanceProductIdLists.add(Maintenance_product_id(
        productId: maintenance_product_id.productId.id,
        categoryId: maintenance_product_id.categoryId.id,
        type: maintenance_product_id.type,
        qty: maintenance_product_id.qty));
  ...
  void deleteMaintenanceProductId(
      Maintenance_product_ids maintenance_product_id) {
    this.maintenanceProductIdList.value.remove(maintenance_product_id);
    this.maintenanceProductIdLists.remove(Maintenance_product_id(
        productId: maintenance_product_id.productId.id,
        categoryId: maintenance_product_id.categoryId.id,
        type: maintenance_product_id.type,
        qty: maintenance_product_id.qty));
    update();
    maintenanceService
        .deleteProductLine(maintenance_product_id.id, box.read('emp_id'))
        .then((data) {
      maintenanceList.value = data;
    });
  }
  ...
  void removeMaintenanceProductId(
      Maintenance_product_ids maintenance_product_id) {
    this.maintenanceProductIdList.value.remove(maintenance_product_id);
    this.maintenanceProductIdLists.remove(Maintenance_product_id(
        productId: maintenance_product_id.productId.id,
  ...
  void updateCameraImage(
      int id, String from, File image, String image64) async {
    image_base64 = image64;
    var index;
    if (from == 'before_one') {
      index = 0;
    ...
    await maintenanceService
        .updateImage(id, index, image64, box.read('emp_id'))
        .then((data) {
      if (from == 'before_one') {
        isShowBeforeOne.value = true;
      } else if (from == 'before_two') {
