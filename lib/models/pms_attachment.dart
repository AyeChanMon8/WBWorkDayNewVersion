...
class PMSattachment {
  ...
  PMSattachment copyWith({int id, String attach_file, String name}) {
  ...
  factory PMSattachment.fromJson(String source) =>
      PMSattachment.fromMap(json.decode(source));

  @override
  String toString() =>
      'PMSattachment(id: $id, attach_file: $attach_file, name: $name)';
