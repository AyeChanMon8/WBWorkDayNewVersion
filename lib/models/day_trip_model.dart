...
class DayTrip_Expense_ids {
  ...
  DayTrip_Expense_ids(
      {DayTrip_Product_id productId, String name, double amount}) {
  ...
  DayTrip_Expense_ids.fromJson(dynamic json) {
    _productId = json["product_id"] != null
        ? DayTrip_Product_id.fromJson(json["product_id"])
        : null;
    _name = json["name"];
    _amount = json["amount"];
    _id = json["id"];
...
class Product_ids {
  ...
  Product_ids.fromJson(dynamic json) {
    ...
    _id = json["id"];
    _uom = json["product_uom"] != null
        ? DayTrip_uom.fromJson(json["product_uom"])
        : null;
  }
}
...
class DayTrip_uom {
  ...
  DayTrip_uom({int id, String name}) {
    _id = id;
    _name = name;
  }
...
class DayTrip_Product_id {
  ...
  DayTrip_Product_id({int id, String name}) {
    _id = id;
    _name = name;
  }
...
class Advance_ids {
  ...
  Advance_ids.fromJson(dynamic json) {
    _expense_categ_id = json["expense_categ_id"] != null
        ? ExpenseCategory_id.fromJson(json["expense_categ_id"])
        : null;
    _quantity = json["quantity"];
    _amount = json["amount"];
...
class ExpenseCategory_id {
  ...
  ExpenseCategory_id({int id, String name}) {
    _id = id;
    _name = name;
  }
