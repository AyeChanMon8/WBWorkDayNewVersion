...
class OTDepartment {
  ...
  OTDepartment copyWith(
      {int id, String name, int branch_id, String branch_name}) {
    return OTDepartment(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  factory OTDepartment.fromJson(String source) =>
      OTDepartment.fromMap(json.decode(source));

  @override
  String toString() =>
      'Department(id: $id, name: $name, branch_id: $branch_id)';
