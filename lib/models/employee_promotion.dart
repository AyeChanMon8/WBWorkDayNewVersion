...
class Employee_promotion {
  ...
  Employee_promotion.fromJson(dynamic json) {
    ...
    _jobGradeId = json["job_grade_id"] != null
        ? Job_grade_id.fromJson(json["job_grade_id"])
        : null;
    _salaryLevelId = json["salary_level_id"] != null
        ? Salary_level_id.fromJson(json["salary_level_id"])
        : null;
    _wage = json["wage"];
    _date = json["date"];
    _newCompanyId = json["new_company_id"] != null
        ? New_company_id.fromJson(json["new_company_id"])
        : null;
    _newBranchId = json["new_branch_id"] != null
        ? New_branch_id.fromJson(json["new_branch_id"])
        : null;
    _newDepartmentId = json["new_department_id"] != null
        ? New_department_id.fromJson(json["new_department_id"])
        : null;
    _newJobId = json["new_job_id"] != null
        ? New_job_id.fromJson(json["new_job_id"])
        : null;
    _newJobGradeId = json["new_job_grade_id"] != null
        ? New_job_grade_id.fromJson(json["new_job_grade_id"])
        : null;
    _newSalaryLevelId = json["new_salary_level_id"] != null
        ? New_salary_level_id.fromJson(json["new_salary_level_id"])
        : null;
...
class New_salary_level_id {
  ...
  New_salary_level_id({int id, String name}) {
    _id = id;
    _name = name;
  }
...
class New_job_grade_id {
  ...
  New_job_grade_id({int id, String name}) {
    _id = id;
    _name = name;
  }
...
class New_department_id {
  ...
  New_department_id({int id, String name}) {
    _id = id;
    _name = name;
  }
...
class New_branch_id {
  ...
  New_branch_id({int id, String name}) {
    _id = id;
    _name = name;
  }
...
class New_company_id {
  ...
  New_company_id({int id, String name}) {
    _id = id;
    _name = name;
  }
...
class Salary_level_id {
  ...
  Salary_level_id({int id, String name}) {
    _id = id;
    _name = name;
  }
