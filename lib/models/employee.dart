...
class Employee {
  ...
  Employee copyWith(
    ...
    return Employee(
        ...
        allow_document:
            this.allow_document == null ? false : allow_leave_report,
        allow_fleet_info:
        ...
        allow_plan_trip_waybill: this.allow_plan_trip_waybill == null
            ? false
            : allow_plan_trip_waybill,
        allow_day_trip: this.allow_day_trip == null ? false : allow_day_trip,
        allow_out_of_pocket:
            this.allow_out_of_pocket == null ? false : allow_out_of_pocket,
        allow_travel_expense:
            this.allow_travel_expense == null ? false : allow_travel_expense,
        allow_purchase_order_approval:
            this.allow_purchase_order_approval == null
                ? false
                : allow_purchase_order_approval,
        allow_employee_benefit: this.allow_employee_benefit == null
            ? false
            : allow_employee_benefit);
  }
