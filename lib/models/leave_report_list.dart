...
class LeaveReportList {
  ...
  @override
  String toString() =>
      'LeaveReportList(employee_id: $employee_id, employee_name: $employee_name, balance_list: $balance_list)';

  @override
  int get hashCode =>
      employee_id.hashCode ^ employee_name.hashCode ^ balance_list.hashCode;
}
