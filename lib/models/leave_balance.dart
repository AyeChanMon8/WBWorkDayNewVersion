...
class LeaveBalance {
  ...
  factory LeaveBalance.fromJson(String source) =>
      LeaveBalance.fromMap(json.decode(source));
  ...
  @override
  int get hashCode {
    return name.hashCode ^ entitle.hashCode ^ taken.hashCode ^ balance.hashCode;
  }
}
