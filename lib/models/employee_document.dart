...
class Employee_document {
  ...
  Employee_document.fromJson(dynamic json) {
    _id = json['id'];
    _name = json['name'];
    _employeeRef = json['employee_ref'] != null
        ? Employee_ref.fromJson(json['employee_ref'])
        : null;
    _documentType = json['document_type'] != null
        ? Document_type.fromJson(json['document_type'])
        : null;
...
class Document_type {
  ...
  Document_type({int id, String name}) {
    _id = id;
    _name = name;
  }
...
class Employee_ref {
  ...
  Employee_ref({int id, String name}) {
    _id = id;
    _name = name;
  }
