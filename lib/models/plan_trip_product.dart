...
class Plan_trip_product {
  ...
  List<Request_allowance_lines> get requestAllowanceLines =>
  ...
  Plan_trip_product.fromJson(dynamic json) {
    ...
    _driverId = json["driver_id"] != null
        ...
        : null;
    _spare1Id = json["spare1_id"] != null
        ? Spare1_id.fromJson(json["spare1_id"])
        : null;
    _spare2Id = json["spare2_id"] != null
        ? Spare2_id.fromJson(json["spare2_id"])
        : null;
...
class Product_ids {
  ...
  Product_ids({Product_id productId, double quantity, double priceUnit}) {
  ...
  Product_ids.fromJson(dynamic json) {
    ...
    _id = json["id"];
    _productUom = json["product_uom"] != null
        ? Product_uom.fromJson(json["product_uom"])
        : null;
  }
...
class Product_uom {
  ...
  Product_uom({int id, String name}) {
    _id = id;
    _name = name;
  }
...
class Request_allowance_lines {
  ...
  Request_allowance_lines.fromJson(dynamic json) {
    _expenseCategId = json["expense_categ_id"] != null
        ? Expense_categ_id.fromJson(json["expense_categ_id"])
        : null;
    _quantity = json["quantity"];
    _amount = json["amount"];
...
class Expense_categ_id {
  ...
  Expense_categ_id({int id, String name}) {
    _id = id;
    _name = name;
  }
...
class Advanced_ids {
  ...
  Advanced_ids({Route_id routeId, double approvedAdvance}) {
    _routeId = routeId;
...
class Fuelin_ids {
  ...
  Fuelin_ids.fromJson(dynamic json) {
    ...
    _location_id = json["location_id"] != null
        ? Stock_location.fromJson(json["location_id"])
        : null;
    _id = json["id"];
