...
class RatingConfig {
  ...
  RatingConfig copyWith({int id, String rating_description, String name}) {
    return RatingConfig(
        id: id ?? this.id,
  ...
  Map<String, dynamic> toMap() {
    return {'id': id, 'rating_description': rating_description, 'name': name};
  }
  ...
  factory RatingConfig.fromJson(String source) =>
      RatingConfig.fromMap(json.decode(source));

  @override
  String toString() =>
      'RatingConfig(id: $id, rating_description: $rating_description, name : $name)';
