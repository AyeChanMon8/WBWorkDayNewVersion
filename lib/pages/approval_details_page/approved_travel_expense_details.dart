...
class _TravelExpenseDetailsState extends State<TravelExpenseApprovedDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    index = Get.arguments;
    controller.getAttachmentTravel(
      ...
      child: DataTable2(
          ...
          rows: [
            for (var i = 0;
                i <
                    controller
                        .travelExpenseApprovedList[index].travel_line.length;
                i++)
              DataRow(cells: [
                ...
                DataCell(
                  controller.travelExpenseApprovedList[index].travel_line[i]
                                  .attachment_include !=
                              null &&
                          controller.travelExpenseApprovedList[index]
                              .travel_line[i].attachment_include
                      ? IconButton(
