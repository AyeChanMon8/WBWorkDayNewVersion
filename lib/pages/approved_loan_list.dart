          ...
          itemBuilder: (BuildContext context, int index) {
            return Card(
              ...
              child: Container(
                ...
                child: InkWell(
                  onTap: () {
                    Get.toNamed(Routes.APPROVED_LOAN_DETAILS, arguments: index);
                  },
                  child: ListTile(
                      leading: Text(AppUtils.removeNullString(
                          controller.loanApprovedList[index].name)),
                      title: Column(
                        ...
                        children: [
                          ...
                          Text(
                              AppUtils.removeNullString(controller
                                  .loanApprovedList.value[index].type),
                              style: TextStyle(color: backgroundIconColor)),
                          SizedBox(height: 5),
                          Text(
                              AppUtils.addThousnadSperator(controller
                                  .loanApprovedList.value[index].loan_amount),
                              style: TextStyle(color: backgroundIconColor)),
                        ],
                      ),
                      subtitle: Align(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(AppUtils.changeDateFormat(controller
                                  .loanApprovedList.value[index].payment_date)),
                            ],
                          ),
                        ),
                      ),
