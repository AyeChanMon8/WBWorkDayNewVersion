...
class _AdminPageState extends State<AdminPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (calender != null) {
      admin.add([Icons.calendar_today, labels?.calendar, Routes.CALENDAR]);
    }
    ...
    if (plan_trip != null) {
      admin.add([
        ...
        labels.plantipProduct,
        Routes.PLAN_TRIP_PAGE
      ]);
    }
    if (plan_trip_waybill != null && plan_trip_waybill == true) {
      admin.add([
        FontAwesomeIcons.suitcaseRolling,
        labels.pantripWaybill,
        Routes.PLAN_TRIP_WAYBILL_PAGE
      ]);
    }
    if (day_trip != null) {
      admin
          .add([FontAwesomeIcons.road, labels?.dayTrip, Routes.DAY_TRIP_TABAR]);
    }
    if (approval != null) {
      admin.add([
    ...
    if (doc != null) {
      admin.add(
          [FontAwesomeIcons.folderOpen, labels?.documents, Routes.DOCUMENTS]);
    }
