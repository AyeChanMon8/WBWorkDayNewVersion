...
class ApprovedOutOfPocketList extends StatefulWidget {
  @override
  _ApprovedOutOfPocketListState createState() =>
      _ApprovedOutOfPocketListState();
}
                ...
                child: InkWell(
                  ...
                  child: ListTile(
                      ...
                      leading: Text(controller
                          .outofpocketExpenseApprovedList[index].number),
                      title: Text(
                          // "Approval 1",
                          controller.outofpocketExpenseApprovedList.value[index]
                              .company_id.name),
                      subtitle: Text(controller.outofpocketExpenseApprovedList
