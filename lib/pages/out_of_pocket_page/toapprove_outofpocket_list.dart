...
class ToApproveOutOfPocketList extends StatefulWidget {
  @override
  _ToApproveOutOfPocketListState createState() =>
      _ToApproveOutOfPocketListState();
}
                ...
                child: InkWell(
                  ...
                  child: ListTile(
                      ...
                      leading: Text(controller
                          .outofpocketExpenseToApproveList[index].number),
                      title: Text(
                          // "Approval 1",
                          controller.outofpocketExpenseToApproveList
                              .value[index].company_id.name),
                      subtitle: Text(controller.outofpocketExpenseToApproveList
