...
class EmployeeBenefitListPage extends StatefulWidget {
  @override
  _EmployeeBenefitListPageState createState() =>
      _EmployeeBenefitListPageState();
}
        ...
        child: Obx(
          () => ListView.builder(
            ...
            itemBuilder: (BuildContext context, int dindex) {
              var status;
              if (controller.employeeBenefitList.value[dindex].state ==
                  'pending') {
                status = 'Pending';
              } else if (controller.employeeBenefitList.value[dindex].state ==
                  'on_hand') {
                status = 'On Hand';
              } else if (controller.employeeBenefitList.value[dindex].state ==
                  'paid') {
              ...
              return Container(
                ...
                child: Card(
                  child: Container(
                    ...
                    child: InkWell(
                      onTap: () {
                        Get.toNamed(Routes.EMPLOYEE_BENEFIT_DETAILS,
                            arguments: dindex);
                      },
                      child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                margin: EdgeInsets.only(
                                    left: 20, bottom: 20, top: 5, right: 20),
                                child: Text(
                                  AppUtils.removeNullString(status.toString()),
                                  style: subtitleStyle(),
                                ),
                              ),
                            ],
