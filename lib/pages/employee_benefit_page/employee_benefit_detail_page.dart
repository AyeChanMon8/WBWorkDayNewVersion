...
class EmployeeBenefitDetailsPage extends StatelessWidget {
  ...
  String image;
  final EmployeeBenefitController controller =
      Get.put(EmployeeBenefitController());
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Obx(
                        () => Container(
                          child: controller
                                      .employeeBenefitList.value[dindex].date !=
                                  null
                              ? Text(
                                  controller
                                      .employeeBenefitList.value[dindex].date,
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Obx(
                        () => Container(
                          child: controller.employeeBenefitList.value[dindex]
                                      .hand_over_date !=
                                  null
                              ? Text(
                                  controller.employeeBenefitList.value[dindex]
                                      .hand_over_date,
                                  style: subtitleStyle(),
                                )
                              : Text('-'),
                ...
                controller.employeeBenefitList.value[dindex].attachment_ids
                            .length >
                        0
                    ? SizedBox(
                        child: GridView.builder(
                            itemCount: controller.employeeBenefitList
                                .value[dindex].attachment_ids.length,
                            shrinkWrap: true,
