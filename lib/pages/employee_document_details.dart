...
class EmployeeDocumentDetails extends StatefulWidget {
  @override
  _EmployeeDocumentDetailsState createState() =>
      _EmployeeDocumentDetailsState();
}

class _EmployeeDocumentDetailsState extends State<EmployeeDocumentDetails> {
  final EmployeeDocumentController controller =
              ...
              children: [
                        ...
                        () => Container(
                          child: Text(
                            AppUtils.removeNullString(
                                controller.docList.value[index].name),
                            style: subtitleStyle(),
                          ),
                        ),
                      ),
                        ...
                        () => Container(
                          child: Text(
                            AppUtils.removeNullString(controller
                                .docList.value[index].documentType.name),
                            style: subtitleStyle(),
                          ),
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Obx(
                        () => Container(
                          child: Text(
                            AppUtils.removeNullString(
                                controller.docList.value[index].issueDate),
                            style: subtitleStyle(),
                          ),
                        ),
                      ),
                ...
                Obx(() => GridView.builder(
                    ...
                    itemBuilder: (context, fileIndex) => InkWell(
                          ...
                          child: controller.attachment_list[fileIndex].type
                                  .contains("pdf")
                              ? InkWell(
                                  onTap: () {
                                  ...
                                  child: Card(
                                    ...
                                    child: Text(controller
                                        .attachment_list[fileIndex].type),
                                  )))
                              : Card(
                                  child: Image.memory(
