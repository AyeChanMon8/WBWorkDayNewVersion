...
class FirstApprovalEmployeeChangeList extends StatefulWidget {
  @override
  _FirstApprovalEmployeeChangeListState createState() =>
      _FirstApprovalEmployeeChangeListState();
}

class _FirstApprovalEmployeeChangeListState
    extends State<FirstApprovalEmployeeChangeList> {
        ...
        body: Obx(
          () => NotificationListener<ScrollNotification>(
              ...
              child: ListView.builder(
                itemCount:
                    controller.employeeChangesFirstApprovalList.value.length,
                  ...
                  return Card(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          Get.toNamed(
                              Routes.FIRST_APPROVAL_EMPLOYEE_CHANGES_DETAILS,
                              arguments: index);
                        },
                        child: ListTile(
                            leading: Text(AppUtils.removeNullString(controller
                                .employeeChangesFirstApprovalList[index].type)),
                            title: Column(
