...
class TravelRequestUpdate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (travelRequest != null) {
      selectedFromDate =
          DateTime.tryParse(controller.fromDateTextController.text);
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget continueButton = FlatButton(
      ...
      onPressed: () {
        Navigator.of(context).pop();
        controller.updateTravelRequest(
            controller.durationController.text, travelRequest.id);
      },
    ); //
      ...
      child: Obx(() => ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              total_amount_controllers = List.generate(
                  ...
                  (index) => TextEditingController(
                      text:
                          '${f.format(controller.expenseList[index].total_amount)}'));
                              ...
                              () => DropdownButtonHideUnderline(
                                child: ButtonTheme(
                                  ...
                                  child: DropdownButton(
                                      isExpanded: true,
                                      value:
                                          controller.travelLineList[index].full
                                              ? 1
                                              : controller.travelLineList[index]
                                                      .first
                                                  ? 2
                                                  : 3,
                                      items: [
