              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Obx(
                      () => Expanded(
                          child: controller.selectedInsuranceType.value
                                      .coverageAmount !=
                                  null
                              ? Text(
                                  '${NumberFormat('#,###').format(double.tryParse(controller.selectedInsuranceType.value.coverageAmount.toString()))}',
                                  style: maintitleStyle())
                              : Text('')),
                    ),
                  ],
                ...
                child: Row(
                  children: [
                    ...
                    Obx(
                      () => Expanded(
                          child: Text(
                              '${NumberFormat('#,###').format(double.tryParse(controller.balanceAmount.value.toString()))}',
                              style: maintitleStyle())),
                    ),
                  ],
                ),
