...
class ApprovedTravelExpenseList extends StatefulWidget {
  @override
  _ApprovedTravelExpenseListState createState() =>
      _ApprovedTravelExpenseListState();
}
              ...
              child: Container(
                ...
                child: InkWell(
                  ...
                  child: ListTile(
                      ...
                      // leading:
                      leading: Text(
                          controller.travelExpenseApprovedList[index].number),
                      title: Text(
                          // "Approval 1",
                          controller.travelExpenseApprovedList.value[index]
                              .company_id.name),
                      subtitle: Text(controller.travelExpenseApprovedList
