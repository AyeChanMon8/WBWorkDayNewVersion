    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int ind) {
          var start_date = controller.leaveList[index].leave_line[ind].date;
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        // color: Colors.blue,
                        // width: 80,
                        child: Text(AppUtils.changeDateFormat(startDate)),
                      ),
                    ),
                    Expanded(
                      child: Container(
                        ...
                        // color: Colors.red,
                        // width: 80,
                        child: Text(AppUtils.changeDateFormat(endDate)),
                      ),
                    ),
                    Expanded(
                      child: Container(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Container(
                child:
                    controller.leaveList.value[index].duration_unpaid_leave !=
                            null
                        ? Text(
                            AppUtils.removeNullString(controller.leaveList
                                    .value[index].duration_unpaid_leave
                                    .toString()) +
                                " Days",
                            style: subtitleStyle())
                        : Text('-'),
              ...
              Container(
                child: controller.leaveList.value[index].description != null
                    ? Flexible(
                        child: Text(
                            controller
                                .leaveList.value[index].description.capitalize,
                            style: subtitleStyle()),
                      )
                    : Text('-'),
              ),
