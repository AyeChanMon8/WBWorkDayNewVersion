          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                // leaveData(context),
                Text(
                  controller.tripExpenseApprovedList.value[index].number,
                ...
                Align(
                    ...
                    child: Container(
                        ...
                        child: Text(
                          '${labels?.total} Amount : ${NumberFormat('#,###.#').format(controller.getTotaltripExpenseApprovedAmount(index))}',
                          style:
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 2,
                      child: Text(
                        controller.tripExpenseApprovedList[index]
                    ...
                    Expanded(
                      flex: 2,
                      child: controller.tripExpenseApprovedList[index]
                                  .trip_expense_lines[ind].description !=
                              null
                          ? Text(controller.tripExpenseApprovedList[index]
                              .trip_expense_lines[ind].description
                              .toString())
                          : SizedBox(),
                    ),
                    Expanded(
                      flex: 2,
                      child: Text(controller.tripExpenseApprovedList[index]
                          .trip_expense_lines[ind].price_subtotal
                          .toString()),
                    ),
                    Expanded(
                      flex: 1,
                      child: controller.tripExpenseApprovedList[index]
                                  .trip_expense_lines[ind].attached_file !=
                              null
                          ? IconButton(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Container(
                child: controller
                            .tripExpenseApprovedList.value[index].source_doc !=
                        null
                    ? Text(
                        controller
                            .tripExpenseApprovedList.value[index].source_doc,
          ...
          Row(
            ...
            children: [
              ...
              Container(
                child:
                    controller.tripExpenseApprovedList.value[index].date != null
                        ? Text(
                            AppUtils.changeDateFormat(controller
                                .tripExpenseApprovedList.value[index].date),
                            style: subtitleStyle())
                        : Text('-'),
              ),
            ],
            ...
            children: [
              ...
              Container(
                child: controller.tripExpenseApprovedList.value[index].state !=
                        null
                    ? Text(
                        controller.tripExpenseApprovedList.value[index].state,
                        style: subtitleStyle())
                    : Text('-'),
              ),
            ],
