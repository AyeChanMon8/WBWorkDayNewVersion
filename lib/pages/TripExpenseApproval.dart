...
class _ApprovalDetailsState extends State<TripExpenseApproval> {
  ...
  Widget build(BuildContext context) {
    ...
    index = Get.arguments;
    controller
        .getAttachmentTrip(controller.tripExpenseToApproveList.value[index].id);
            ...
            children: [
              ...
              Expanded(
                ...
                child: Align(
                    ...
                    child: Text('Amt', style: subtitleStyle())),
              ),
              Expanded(
                flex: 1,
                child: Padding(
                  ...
                  child: Align(
                      alignment: Alignment.centerRight,
                      child: Text('Over Amt', style: subtitleStyle())),
                ),
              ),
              Expanded(
                flex: 1,
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: IconButton(
                          icon: Icon(Icons.attach_file),
                          onPressed: () async {
                            print(controller.tripExpenseToApproveList
                                .value[index].trip_expense_lines[ind].id);
                            controller
