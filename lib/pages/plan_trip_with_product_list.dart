          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              var from_date = AppUtils.changeDefaultDateTimeFormat(controller
                  .plantrip_with_product_list.value[index].fromDatetime);
              var to_date = AppUtils.changeDefaultDateTimeFormat(controller
                  .plantrip_with_product_list.value[index].toDatetime);
              var routes = "";
              var route_names = [];
              if (controller.plantrip_with_product_list.value[index]
                      .routePlanIds.length !=
                  0) {
                controller.plantrip_with_product_list.value[index].routePlanIds
                    .forEach((element) {
              ...
              return Container(
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    //   }
                    // });
                    Get.toNamed(Routes.PLANTRIP_DETAILS, arguments: index)
                        .then((value) {
                      if (value != null) {
                        controller.offset.value = 0;
                        controller.getPlantripList(widget.pageType);
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                controller.plantrip_with_product_list
                                        .value[index].name ??
                                    '',
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              controller.plantrip_with_product_list[index]
                                          .driverId.name ==
                                      null
                                  ? Text("-")
                                  : AutoSizeText(
                                      '${controller.plantrip_with_product_list[index].driverId.name}',
                                      style: datalistStyle(),
                                    )
                            ],
                          ),
                        ...
                        Row(
                          ...
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  controller.plantrip_with_product_list[index]
                                      ...
                                      ? Text("-")
                                      : AutoSizeText(
                                          '(${controller.plantrip_with_product_list[index].spare1Id.name})',
                                          style: datalistStyle(),
                                        )
                                ],
                              ),
                            ...
                            Container(
                              ...
                              child: controller.plantrip_with_product_list
                                          .value[index].state ==
                                      'open'
                                  ? controller.plantrip_with_product_list
