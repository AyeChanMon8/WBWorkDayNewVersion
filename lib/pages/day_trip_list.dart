...
class _DayTripListPageState extends State<DayTripListPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(
        () => dayTripController.dayTripList.value == null
            ? Container()
            : NotificationListener<ScrollNotification>(
                onNotification: (ScrollNotification scrollInfo) {
                  if (!dayTripController.isLoading.value &&
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      DayTripModel dayTripModel =
                          dayTripController.dayTripList.value[index];
                      ...
                      var to_date = AppUtils.changeDefaultDateTimeFormat(
                          dayTripModel.toDatetime);
                      return Card(
                          elevation: 5,
                          child: InkWell(
                            onTap: () {
                              dayTripController.current_page.value =
                                  widget.pageType;
                              Get.toNamed(Routes.CREATE_DAY_TRIP,
                                      arguments: index)
                                  .then((value) {
                                if (value != null) {
                                  ...
                                  dayTripController
                                      .getDayTripList(widget.pageType);
                                }
                              });
                            },
                            child: Container(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      dayTripModel.state == 'open'
                                          ? dayTripModel.driverId.id == emp_id
                                              ? AutoSizeText(
                                                  dayTripModel.state
                                                          .toUpperCase() +
                                                      " >>",
