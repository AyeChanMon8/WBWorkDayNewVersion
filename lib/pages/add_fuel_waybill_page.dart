...
class AddFuelWayBillPage extends StatelessWidget {
  ...
  var to_date = "";
  var line_id = 0;
  AddFuelWayBillPage(String from, int daytrip_id, String fromDatetime,
      String toDateTime, WayBill_Fuelin_ids fuelInId) {
    ...
    if (fuelInId != null) {
      ...
      day_trip_controller.totalFuelInAmtController.text =
          fuelInId.amount.toString();
