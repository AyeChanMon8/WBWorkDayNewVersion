            ...
            itemBuilder: (BuildContext context, int index) {
              return Card(
                child: Container(
                  ...
                  child: InkWell(
                    onTap: () {
                      Get.toNamed(Routes.INSURANCE_APPROVAL, arguments: index);
                    },
                    child: ListTile(
                        leading:
                            Text(controller.insuranceApprovalList[index].name),
                        title: Text(
                            // "Approval 1",
                            controller.insuranceApprovalList.value[index]
                                .employeeId.name),
                        subtitle: Text(controller
                            .insuranceApprovalList.value[index].coverageAmount
                            .toString()),
