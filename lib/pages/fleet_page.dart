  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Obx(
          () => controller.fleetModel.value.name != null
              ? Card(
                  elevation: 0,
                  child: Container(
                      ...
                      children: [
                        Center(
                            child: Container(
                                height: 100,
                                width: 100,
                                child: controller.fleetModel.value.image128 !=
                                        null
                                    ? Image.memory(base64Decode(
                                        controller.fleetModel.value.image128))
                                    : Container())),
                        SizedBox(
                          height: 10,
                        ),
                                ...
                                children: [
                                  ...
                                  Container(
                                    child: Text(controller
                                            .fleetModel.value.odometer
                                            .toString() +
                                        " " +
                                        controller
                                            .fleetModel.value.odometerUnit),
                                  )
                                ],
                              ),
                            ),
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Container(
                                    child: Obx(
                                      () => Text(controller
                                              .totalFuelConsumptionLiter.value
                                              .toStringAsFixed(2) +
                                          labels.liter),
                                    ),
                                  )
      ...
      () => ListView.builder(
          ...
          itemBuilder: (context, index) {
            Fleet_insurance insurance =
                controller.fleetInsuranceList.value[index];
            return InkWell(
              onTap: () {
                Get.toNamed(Routes.FLEET_INSURANCE_DETAIL,
                    arguments: controller.fleetInsuranceList.value[index]);
              },
              child: Card(
                elevation: 10,
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AutoSizeText(
                        insurance.insuranceTypeId.name,
                        style: datalistStyle(),
                      ),
                      AutoSizeText(
                        '${AppUtils.changeDateFormat(insurance.startDate)})} - ${AppUtils.changeDateFormat(insurance.endDate)}',
                        style: datalistStyle(),
                      ),
                    ],
                  ),
  ...
  Widget maintenanceList(BuildContext context) {
    ...
    return Container(
      ...
      () => ListView.builder(
          ...
          itemBuilder: (context, index) {
            Maintenance_request_model maintenance_request_model =
                controller.maintenanceList.value[index];
            return InkWell(
              onTap: () {
              ...
              child: Card(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      AutoSizeText(
                        labels.name + ' : ${maintenance_request_model.name}',
                        style: datalistStyle(),
                      ),
                      AutoSizeText(
                        labels.maintenanceType +
                            ' : ${maintenance_request_model.maintenanceType ?? ''}',
                        style: datalistStyle(),
                      ),
                      AutoSizeText(
                        labels.maintenanceTeam +
                            ' : ${maintenance_request_model.maintenanceTeamId.name ?? ''}',
                        style: datalistStyle(),
                      ),
                      maintenance_request_model.startDate != null &&
                              maintenance_request_model.endDate != null
                          ? AutoSizeText(
                              '${AppUtils.changeDateFormat(maintenance_request_model.startDate)} - ${AppUtils.changeDateFormat(maintenance_request_model.endDate)}',
                              style: datalistStyle(),
                            )
                          : AutoSizeText(
                              '${AppUtils.formatter.format(DateTime.parse(maintenance_request_model.requestDate))}',
                              style: datalistStyle(),
                            ),
                      RatingBar.builder(
                        initialRating: double.parse(
                            maintenance_request_model.priority ?? '0'),
                        minRating: 1,
  ...
  Widget fuelConsumptionList(BuildContext context) {
    ...
    return Container(
      ...
      () => ListView.builder(
          ...
          itemBuilder: (context, index) {
            ConsumptionAverageHistory fuelComsumptionModel =
                controller.fueComsumptionList.value[index];
            return InkWell(
              onTap: () {
                //Get.toNamed(Routes.FLEET_INSURANCE_DETAIL,arguments:controller.fleetInsuranceList.value[index] );
              },
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          AutoSizeText(
                            labels.sourceDoc,
                            style: datalistStylenotBold(),
                          ),
                          AutoSizeText(
                            '${fuelComsumptionModel.source_doc ?? ''}',
                            style: datalistStyle(),
                          ),
                        ],
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          AutoSizeText(
                            labels.consumptionLiter,
                            style: datalistStylenotBold(),
                          ),
                          AutoSizeText(
                            '${fuelComsumptionModel.consumption_liter ?? ''}',
                            style: datalistStyle(),
                          ),
                        ],
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          AutoSizeText(
                            labels.consumptionAvg,
                            style: datalistStylenotBold(),
                          ),
                          AutoSizeText(
                            '${fuelComsumptionModel.great_average == null ? '' : NumberFormat('#,###').format(double.tryParse(fuelComsumptionModel.great_average.toString()))}',
                            style: datalistStyle(),
                          ),
                        ],
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          AutoSizeText(
                            '${AppUtils.addThousnadSperator(fuelComsumptionModel.odometer) ?? ''}',
                            style: datalistStyle(),
                          ),
                        ],
                      ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          AutoSizeText(
                            '${AppUtils.changeDateFormat(tyredModel.date) ?? ''}',
                            style: datalistStyle(),
                          ),
                        ],
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          AutoSizeText(
                            '${tyredModel.used_points == null ? '' : NumberFormat('#,###').format(double.tryParse(tyredModel.used_points.toString()))}',
                            style: datalistStyle(),
                          ),
                        ],
                      ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          AutoSizeText(
                            '${fuelLogModel.amount == null ? '' : NumberFormat('#,###').format(double.tryParse(fuelLogModel.amount.toString()))}',
                            style: datalistStyle(),
                          ),
                        ],
                      ),
        ...
        children: [
            ...
            children: [
              ...
              Container(
                child: Text(AppUtils.changeDateFormat(
                    controller.fleetModel.value.acquisitionDate)),
              )
            ],
          ),
          SizedBox(
          ...
          Row(
            ...
            children: [
              ...
              Container(
                child: Text(
                    controller.fleetModel.value.traccarUniqueID.toString()),
              )
            ],
          ),
          SizedBox(
              ...
              child: Card(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      AutoSizeText(
                        'Date : ${fuelLogModel.filling_date == null ? '' : fuelLogModel.filling_date}',
                        style: datalistStyle(),
                      ),
                      AutoSizeText(
                        'Source Doc : ${fuelLogModel.source_doc ?? ''}',
                        style: datalistStyle(),
                      ),
                      AutoSizeText(
                        'Fuel Liter : ${fuelLogModel.fuel_liter ?? ''}',
                        style: datalistStyle(),
                      ),
                      AutoSizeText(
                        'Price  : ${fuelLogModel.price_per_liter == null ? '' : NumberFormat('#,###').format(double.tryParse(fuelLogModel.price_per_liter.toString()))}',
                        style: datalistStyle(),
                      ),
                    ],
                  ),
