                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Container(
                              child: Text(
                                controller.leave_report_list.value[index]
                                    .employee_name,
                                style: labelPrimaryHightlightTextStyle(),
                              ),
                            ),
                          ...
                          Expanded(
                            child: leavedWidget(context, index),
                            flex: 3,
                          ),
                        ],
                      ),
    ...
    return Obx(
      () => Container(
        child: ListView.builder(
          ...
          physics: NeverScrollableScrollPhysics(),
          itemCount:
              controller.leave_report_list.value[index].balance_list.length,
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Align(
                          alignment: Alignment.centerRight,
                          child: Text(
                              '${controller.leave_report_list.value[index].balance_list[position].entitle.toStringAsFixed(1)}')),
                    ),
                    SizedBox(
                      width: 20,
                    ),
                    Expanded(
                      ...
                      child: Align(
                          alignment: Alignment.centerRight,
                          child: Text(controller.leave_report_list.value[index]
                              .balance_list[position].taken
                              .toString())),
                    ),
                    SizedBox(
                      width: 20,
                    ...
                    Expanded(
                        ...
                        child: Align(
                            alignment: Alignment.centerRight,
                            child: Text(controller.leave_report_list
                                .value[index].balance_list[position].balance
                                .toStringAsFixed(1)))),
                  ]),
            );
          },
                        ...
                        child: Theme(
                          ...
                          child: TextField(
                            ...
                            onChanged: (text) {
                              ...
                              controller.leave_report_list.value = leaveReport
                                  .toList()
                                  .where((element) =>
                                      element.employee_name.contains(text))
                                  .toList();
                            },
                          ),
                        )),
