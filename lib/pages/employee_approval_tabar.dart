...
class EmployeeChangeApprovalTabBar extends StatefulWidget {
  @override
  _StateEmployeeChangeApprovalTabBar createState() =>
      _StateEmployeeChangeApprovalTabBar();
}

class _StateEmployeeChangeApprovalTabBar
    extends State<EmployeeChangeApprovalTabBar> {
  int tabbar;
  @override
  void initState() {
    super.initState();
