...
class ApprovalEmployeeChangeList extends StatefulWidget {
  @override
  _ApprovalEmployeeChangeListState createState() =>
      _ApprovalEmployeeChangeListState();
}

class _ApprovalEmployeeChangeListState
    extends State<ApprovalEmployeeChangeList> {
                  ...
                  child: InkWell(
                    ...
                    child: ListTile(
                        leading: Text(AppUtils.removeNullString(controller
                            .employeeChangesApprovalList[index].type)),
                        title: Column(
