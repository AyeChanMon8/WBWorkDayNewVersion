...
class ApprovedTripExpenseList extends StatefulWidget {
  @override
  _ApprovedTripExpenseListState createState() =>
      _ApprovedTripExpenseListState();
}
              ...
              child: Container(
                ...
                child: InkWell(
                  ...
                  child: ListTile(
                      ...
                      // leading:
                      leading: Text(
                          controller.tripExpenseApprovedList[index].number),
                      title: Text(
                          // "Approval 1",
                          controller.tripExpenseApprovedList.value[index]
                              .company_id.name),
                      subtitle: Text(controller.tripExpenseApprovedList
