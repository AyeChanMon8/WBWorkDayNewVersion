...
class CreateRouteDatePlanTripWaybill extends StatefulWidget {
  @override
  State<CreateRouteDatePlanTripWaybill> createState() =>
      _CreateRouteDatePlanTripWaybillState();
}

class _CreateRouteDatePlanTripWaybillState
    extends State<CreateRouteDatePlanTripWaybill> {
  ...
  Future<Null> _selectDate(BuildContext context, String date) async {
    final DateTime picked = await showDatePicker(
      context: context,
      initialDate: date == 'Start Date'
          ? (controller.fromDateTextController.text != null &&
                  controller.fromDateTextController.text != ""
              ? DateTime.parse(controller.fromDateTextController.text)
              : DateTime.now())
          : (controller.toDateTextController.text != null &&
                  controller.toDateTextController.text != ""
              ? DateTime.parse(controller.toDateTextController.text)
              : DateTime.now()),
      firstDate: date == 'Start Date'
          ? (controller.fromDateTextController.text != null &&
                  controller.fromDateTextController.text != ""
              ? DateTime.parse(controller.fromDateTextController.text)
              : DateTime.now())
