...
class _MainState extends State<HomePage> {
  ...
  Future<void> initPlatformState() async {
    ...
    // });
    OneSignal.shared.setAppId("958cdaa9-2850-48d9-9d97-51bf14f69a78");
            ...
            child: Container(
              ...
              child: Obx(() => CircleAvatar(
                    ...
                    child: ClipRRect(
                      ...
                      child: controller.emp_base64.value != null &&
                              controller.emp_base64.value.isNotEmpty
                          ? Image.memory(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Container(
                            child: Text(
                              controller.announcementList.value.length
                                  .toString(),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Obx(() => Container(
                                child: Text(
                                  notiController.unReadMsgCount.toString(),
                                  style: TextStyle(color: Colors.white),
                                ),
                                padding: EdgeInsets.all(5),
                                decoration: BoxDecoration(
