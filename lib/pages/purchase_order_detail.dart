...
class _PurchaseOrderDetailsState extends State<PurchaseOrderDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    list =
        controller.purchaseOrderApprovalList.value[index].reject_reasons_list;
    if (controller
            .purchaseOrderApprovalList.value[index].reject_reasons_list.length >
        0) {
      reject_controller.text = controller
          .purchaseOrderApprovalList.value[index].reject_reasons_list[0];
    } else {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            controller.purchaseOrderApprovalList.length > 0
                ? purchaseOrderWidget(context)
                : SizedBox(),
            SizedBox(
              height: 10,
            ),
  ...
  showOptionsDialog() {
    Widget okButton = FlatButton(
      ...
      onPressed: () {
        ...
        controller.declinedPurchaseOrder(
            controller.purchaseOrderApprovalList.value[index].id,
            reject_controller.text);
      },
    );
  ...
  Widget purchaseOrderWidget(BuildContext context) {
    return Obx(() => controller.purchaseOrderApprovalList.length > 0
        ? Container(
                                    ...
                                    ? Align(
                                        ...
                                        child: Text(
                                            controller
                                                ...
                                                .name,
                                            style:
                                                labelPrimaryHightlightTextStyle()),
                                      )
                                    : Align(
                                        alignment: Alignment.centerRight,
                                        child: Text('-')),
