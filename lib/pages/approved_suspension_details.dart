...
class ApprovedSuspensionDetails extends StatefulWidget {
  @override
  _ApprovedSuspensionDetailsState createState() =>
      _ApprovedSuspensionDetailsState();
}
        ...
        child: SingleChildScrollView(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Container(
                  child: controller.suspensionApprovedList.length > 0 &&
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Obx(
                        () => Container(
                          child: controller.suspensionApprovedList.length > 0 &&
                                  controller.suspensionApprovedList.value[index]
                                          .employeeId !=
                                      null
                              ? Text(
                                  controller.suspensionApprovedList.value[index]
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          ...
                          child: Container(
                            child:
                                controller.suspensionApprovedList.length > 0 &&
                                        controller.suspensionApprovedList
                          ...
                          child: Align(
                            ...
                            child: Container(
                              child: Padding(
                                ...
                                child:
                                    controller.suspensionApprovedList.length >
                                                0 &&
                                            controller.suspensionApprovedList
                      ...
                      Obx(
                        () => Expanded(
                          ...
                          child: Align(
                            alignment: Alignment.topRight,
                            child: Container(
                              child: controller.suspensionApprovedList
                                          .value[index].suspension_reason !=
                                      null
                                  ? Text(
                                      controller.suspensionApprovedList
                                          .value[index].suspension_reason,
