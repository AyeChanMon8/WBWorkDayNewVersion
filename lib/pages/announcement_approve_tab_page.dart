...
class AnnouncementApprovalTabBar extends StatefulWidget {
  @override
  _StateAnnouncementApprovalTabBar createState() =>
      _StateAnnouncementApprovalTabBar();
}

class _StateAnnouncementApprovalTabBar
    extends State<AnnouncementApprovalTabBar> {
  @override
  void initState() {
    super.initState();
  }
