...
class EmployeeChangeCreateForm extends StatefulWidget {
  @override
  _StateEmployeeChangeCreateForm createState() =>
      _StateEmployeeChangeCreateForm();
}
          ...
          child: Obx(
            () => DropdownButtonHideUnderline(
              child: DropdownButton<Emp_job>(
                  ...
                  items: controller.employee_list.map((Emp_job emp) {
          ...
          child: Obx(
            () => DropdownButtonHideUnderline(
              child: DropdownButton<Emp_job>(
                  ...
                  items: controller.manager_employee_list.map((Emp_job emp) {
                    return DropdownMenuItem<Emp_job>(
                      value: emp,
                      child: Padding(
                        padding: const EdgeInsets.only(left: 10),
                    ...
                    () => DropdownButtonHideUnderline(
                      child: DropdownButton<Company_id>(
                          ...
                          onChanged: (Company_id value) {
                            controller.onChangeCompanyDropdown(
                                value, labels.new1);
                          },
                          items:
                  ...
                  child: Obx(
                    () => DropdownButtonHideUnderline(
                      child: DropdownButton<Company_id>(
                          ...
                          items: controller.old_company_list
                    ...
                    () => DropdownButtonHideUnderline(
                      child: DropdownButton<Department>(
                          ...
                          onChanged: (Department value) {
                            controller.onChangeDepartmentDropdown(
                                value, labels.new1);
                          },
                          items:
                  ...
                  child: Obx(
                    () => DropdownButtonHideUnderline(
                      child: DropdownButton<Department>(
                          ...
                          items: controller.old_department_list
                              .map((Department dept) {
                            return DropdownMenuItem<Department>(
                              value: dept,
                              child: Padding(
                    ...
                    () => DropdownButtonHideUnderline(
                      child: DropdownButton<Branch_id>(
                          ...
                          onChanged: (Branch_id value) {
                            controller.onChangeBranchDropdown(
                                value, labels.new1);
                          },
                          items: controller.branch_list.map((Branch_id branch) {
                  ...
                  child: Obx(
                    () => DropdownButtonHideUnderline(
                      child: DropdownButton<Branch_id>(
                          ...
                          items: controller.old_branch_list
                  ...
                  child: Obx(
                    () => DropdownButtonHideUnderline(
                      child: DropdownButton<Company>(
                          ...
                          items: controller.jobgrade_list.map((Company branch) {
                            return DropdownMenuItem<Company>(
                              value: branch,
                              child: Padding(
                                padding: const EdgeInsets.only(left: 10),
                  ...
                  child: Obx(
                    () => DropdownButtonHideUnderline(
                      child: DropdownButton<Company>(
                          ...
                          items: controller.salary_level_list
                              .map((Company branch) {
                            return DropdownMenuItem<Company>(
                              value: branch,
                              child: Padding(
                    ...
                    () => Expanded(
                      ...
                      child: Padding(
                        ...
                        child: Text(AppUtils.removeNullString(
                            controller.selectedEmployee.job_name)),
                      ),
                    ),
                  ),
                ],
                  ...
                  Obx(
                    () => Expanded(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(AppUtils.removeNullString(
                            controller.old_jobgrade_name.value)),
                      ),
                    ),
                  ),
                ],
                  ...
                  Obx(
                    () => Expanded(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(AppUtils.removeNullString(
                            controller.old_salary_level_name.value)),
                      ),
                    ),
                  ),
                ],
                ...
                children: [
                  Expanded(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child:
                          Text(labels.newJobPosition, style: datalistStyle()),
                    ),
                  ),
                  Expanded(
                    flex: 2,
                ...
                children: [
                  Expanded(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child:
                          Text(labels.newSalaryLevel, style: datalistStyle()),
                    ),
                  ),
                  Expanded(
                    flex: 2,
                ...
                children: [
                  Expanded(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child:
                          Text(labels.approvedManager, style: datalistStyle()),
                    ),
                  ),
                  Expanded(
                    flex: 2,
