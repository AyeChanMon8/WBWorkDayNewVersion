            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Obx(
                        () => Container(
                          child: controller
                                      .loanList[dindex].job_position.name !=
                                  null
                              ? Text(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          child: Text(
                            AppUtils.changeDateFormat(
                                controller.loanList[dindex].payment_date),
                            style: subtitleStyle(),
                          ),
                        ),
                      ],
                ...
                controller.loanList.value[dindex].attachment != null
                    ? InkWell(
                        onTap: () async {
                          controller.loanList.value[dindex].attachment_filename
                                  .contains('pdf')
                              ? _createFileFromString(controller
                                      .loanList.value[dindex].attachment
                                      .toString())
                                  .then((path) async {
                            ...
                            child: Center(
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: AutoSizeText(
                                      controller.loanList.value[dindex]
                                                  .attachment_filename !=
                                              null
                                          ? controller.loanList.value[dindex]
                                              .attachment_filename
                      ...
                      children: [
                        Container(
                          child: Text(AppUtils.changeDateFormat(controller
                              .loanList[dindex].loan_lines[index].date)),
                        ),
                        Container(
