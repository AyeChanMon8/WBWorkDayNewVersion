        ...
        body: Obx(
          () => NotificationListener<ScrollNotification>(
            ...
            child: GridView.builder(
                ...
                itemCount:
                    controller.docList[arguments_index].documentList.length,
                shrinkWrap: true,
                  ...
                  return InkWell(
                    onTap: () async {
                      File file = await controller.getDoc(
                          controller.docList[arguments_index]
                              .documentList[fileIndex].documentId,
                          controller.docList[arguments_index]
                              .documentList[fileIndex].file_type);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              controller.docList[arguments_index]
                                  .documentList[fileIndex].documentName,
                              style: subtitleStyle(),
                            ),
                          ),
                          Row(
                                ...
                                child: Text(
                                  "Type - " +
                                      AppUtils.removeNullString(controller
                                          .docList[arguments_index]
                                          .documentList[fileIndex]
                                          .file_type),
                                  style: datalistStyle(),
                                ),
                              ),
