...
class _ApprovalLoanDetailsState extends State<ApprovalLoanDetails> {
    ...
    return Scaffold(
      ...
      body: Scrollbar(
        ...
        child: SingleChildScrollView(
          controller: scrollController,
          child: controller.loanApprovalList.value.length > 0
              ? Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        child: Row(
                          ...
                          children: [
                            ...
                            Obx(
                              () => controller.loanApprovalList.length > 0
                                  ? Container(
                                      child: Text(
                                        controller
                                            .loanApprovalList[index].state,
                                        style: subtitleStyle(),
                                      ),
                                    )
                                  : SizedBox(),
                      ...
                      Container(
                        child: Row(
                          ...
                          children: [
                            ...
                            Obx(
                              () => controller.loanApprovalList.value.length > 0
                                  ? Container(
                                      child: Text(
                                        controller.loanApprovalList.value[index]
                                            .employee_id.name,
                                        style: subtitleStyle(),
                                      ),
                                    )
                      ...
                      controller.loanApprovalList.value[index].attachment !=
                              null
                          ? InkWell(
                              onTap: () async {
                                controller.loanApprovalList.value[index]
                      ...
                      Container(
                        child:
                            Text(labels?.installments, style: datalistStyle()),
                      ),
                      SizedBox(
                        height: 20,
                      ),
  ...
  Widget installmentWidget(BuildContext context) {
    final labels = AppLocalizations.of(context);
    return Obx(() => controller.loanApprovalList.value.length > 0
        ? Container(
            child: ListView.builder(
              physics: NeverScrollableScrollPhysics(),
              shrinkWrap: true,
              itemCount:
                  controller.loanApprovalList.value[index].loan_lines.length,
                    ...
                    Container(
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            child: Text(controller.loanApprovalList.value[index]
                                .loan_lines[pos].state),
                          ),
                          Container(
                            child: Text(NumberFormat('#,###').format(
                                double.tryParse(controller.loanApprovalList
                                    .value[index].loan_lines[pos].amount
                                    .toString()))),
                          ),
                        ],
                      ),
        ...
        children: [
          ...
          Expanded(
            child: GFButton(
              onPressed: () {
                controller
                    .declinedLoan(controller.loanApprovalList.value[index].id);
              },
