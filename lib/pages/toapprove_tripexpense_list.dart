...
class ToApproveTripExpenseList extends StatefulWidget {
  @override
  _ToApproveTripExpenseListState createState() =>
      _ToApproveTripExpenseListState();
}
          ...
          itemBuilder: (BuildContext context, int index) {
            return Card(
              child: Container(
                ...
                child: InkWell(
                  onTap: () {
                    Get.toNamed(Routes.TRIP_EXPENSE_APPROVAL, arguments: index);
                  },
                  child: ListTile(
                      ...
                      // leading:
                      leading: Text(
                          controller.tripExpenseToApproveList[index].number),
                      title: Text(
                          // "Approval 1",
                          controller.tripExpenseToApproveList.value[index]
                              .company_id.name),
                      subtitle: Text(controller.tripExpenseToApproveList
