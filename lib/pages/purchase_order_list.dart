              ...
              return Container(
                ...
                child: Card(
                  child: Container(
                    ...
                    child: InkWell(
                      onTap: () {
                        Get.toNamed(Routes.PURCHASE_ORDER_DETAIL,
                            arguments: dindex);
                      },
                      child: Column(
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                    controller.purchaseOrderApprovalList
                                        .value[dindex].name,
                                    style: subtitleStyle()),
                              ),
                            ],
