...
class TravelDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (Get.arguments.runtimeType == int) index = Get.arguments;
              ...
              if (controller.getTotalAmount(index) > 0)
                Align(
                    ...
                    child: Container(
                        ...
                        child: Text(
                          '${labels?.total} Amount : ${format.format(controller.getTotalAmount(index))}',
                          style:
              ...
              Container(
                child: Text(
                  AppUtils.changeDateFormat(
                      controller.travelLineList.value[index].start_date),
                  style: subtitleStyle(),
                ),
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Container(
                child: Text(
                  (AppUtils.changeDateFormat(
                      controller.travelLineList.value[index].end_date)),
                  style: subtitleStyle(),
                ),
              ),
            ],
