...
class ApprovalSuspensionDetails extends StatefulWidget {
  @override
  _ApprovalSuspensionDetailsState createState() =>
      _ApprovalSuspensionDetailsState();
}
    ...
    return Scaffold(
      ...
      body: Scrollbar(
        ...
        child: SingleChildScrollView(
          controller: scrollController,
          child: controller.suspensionApprovalList.value.length > 0
              ? Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        child: controller.suspensionApprovalList.length > 0 &&
                                controller.suspensionApprovalList.value[index]
                                        .name !=
                                    null
                            ? Text(
                                AppUtils.removeNullString(controller
                                    .suspensionApprovalList.value[index].name),
                                style: subtitleStyle(),
                              )
                            : SizedBox(),
                      ),
                      ...
                      Container(
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              child: controller.suspensionApprovalList.length >
                                          0 &&
                                      controller.suspensionApprovalList
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              ...
                              child: Container(
                                child:
                                    controller.suspensionApprovalList.length >
                                                0 &&
                                            controller.suspensionApprovalList
                                                    .value[index].company_id !=
                                                null
                                        ? Text(
                                            AppUtils.removeNullString(controller
                                                .suspensionApprovalList
                              ...
                              child: Align(
                                ...
                                child: Container(
                                  child: Padding(
                                    ...
                                    child: controller.suspensionApprovalList
                                                    .length >
                                                0 &&
                                            controller.suspensionApprovalList
                                                    .value[index].branch_id !=
                                                null
                                        ? Text(
                                            AppUtils.removeNullString(controller
                                                .suspensionApprovalList
      ...
      child: Row(
        children: [
          Expanded(
            child: GFButton(
              onPressed: () {
                controller.approveSuspension(
                    controller.suspensionApprovalList.value[index].id, context);
                print("Loan approved");
              },
              text: labels?.approve,
              blockButton: true,
