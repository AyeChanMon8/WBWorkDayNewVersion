...
class _SettingPageState extends State<SettingPage> {
  ...
  void initState() {
    ...
    hr.add([Icons.person, labels?.profile, Routes.PROFILE_PAGE]);
    hr.add([Icons.security, labels?.changePassword, Routes.CHANGE_PASSWORD]);
    if (payslip != null) {
      hr.add([
    ...
    if (loan != null) {
      hr.add([FontAwesomeIcons.handHoldingUsd, labels?.loan, Routes.LOAN_PAGE]);
    }
    if (insurance != null) {
    ...
    hr.add([
      ...
      labels?.employeeDocument,
      Routes.EMPLOYEE_DOCEMENT_PAGE
    ]);
  }
