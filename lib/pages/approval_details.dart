...
class _ApprovalDetailsState extends State<ApprovalDetails> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(
                  () => controller.leave_approve_show.value
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int ind) {
          ...
          var end_date =
              controller.leaveApprovalList[index].leave_line[ind].end_date;
  ...
  Widget leaveData(BuildContext context) {
    ...
    var start_date = AppUtils.changeDateFormat(
        controller.leaveApprovalList.value[index].start_date);
    var end_date = AppUtils.changeDateFormat(
        controller.leaveApprovalList.value[index].end_date);
    final labels = AppLocalizations.of(context);
    return Container(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Container(
                child:
                    controller.leaveApprovalList.value[index].start_date != null
                        ? Text(start_date, style: subtitleStyle())
                        : Text('-'),
              ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Container(
                child:
                    controller.leaveApprovalList.value[index].end_date != null
                        ? Text(end_date, style: subtitleStyle())
                        : Text('-'),
              ),
            ],
          ),
              ...
              Container(
                child: controller.leaveApprovalList.value[index].description !=
                    ...
                    ? Expanded(
                        child: Text(
                            controller
                                .leaveApprovalList.value[index].description,
                            style: subtitleStyle()),
                      )
                    : Text('-'),
              ),
